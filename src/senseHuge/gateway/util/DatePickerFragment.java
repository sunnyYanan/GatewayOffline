...
public class DatePickerFragment extends DialogFragment implements
	...
	// Fragment_dataCenter dataCenter;
		...
		// 绑定监听器
				new TimePickerDialog.OnTimeSetListener() {
					...
					public void onTimeSet(TimePicker arg0, int hourOfDay,
						...
						if (Fragment_dataCenter.isStartDate)
							Fragment_dataCenter.startDateShow.setText(str);
						else
							Fragment_dataCenter.endDateShow.setText(str);
					}
	...
	// String result = null;
	// result = this.getYear() + "-" + this.getMonth() + "-" + this.getDay()
